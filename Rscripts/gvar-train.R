...
tiff("minvar-train.tif",width=2250,height=2250,units="px",pointsize=12, res=300)
boxplot(df.minvar[bxpindex+1],col=colvec.s[bxpindex],xlab="Model",ylab="Minimum genetic variance",cex.lab=1.5)
dev.off()

tiff("tminvar-train.tif",width=2250,height=2250,units="px", pointsize=12, res=300)
boxplot(df.tminvar[bxpindex+1],col=colvec.s[bxpindex],xlab="Model",ylab="Generations to genetic bottleneck",cex.lab=1.5)
dev.off()

tiff("gvar0-train.tif",width=2250,height=2250,units="px", pointsize=12, res=300)
boxplot(df.gvar0[bxpindex+1],col=colvec.s[bxpindex],ylab="Initial genetic variance",cex.lab=1.5)
dev.off()

tiff("Dvar-train.tif",width=2250,height=2250,units="px", pointsize=12, res=300)
